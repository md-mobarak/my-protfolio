        ...
        <div data-aos="zoom-in"
            ...
            >
                <div className='text-center lg:flex justify-evenly'>
                    <input type="text" name="user_name" placeholder="*Type Your Name" class="input input-bordered bg-neutral input-secondary text-white w-full max-w-xs" />
                ...
                <div className='flex items-center justify-center mt-6 w-full'>
                    <textarea name="message" placeholder='*Type Message' className=' w-[50%] bg-neutral rounded-lg text-white' id="" cols="50" rows="10"></textarea>
                </div>
